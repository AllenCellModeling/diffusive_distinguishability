...
Report bugs at https://github.com/jcass11/diffusive_distinguishability/issues.
...
diffusive_distinguishability could always use more documentation, whether as part of the
official diffusive_distinguishability docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/jcass11/diffusive_distinguishability/issues.
...
Ready to contribute? Here's how to set up `diffusive_distinguishability` for local development.

1. Fork the `diffusive_distinguishability` repo on GitHub.
...
3. The pull request should work for Python 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/jcass11/diffusive_distinguishability/pull_requests
